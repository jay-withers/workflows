...
- Dependency updates come from the shared presets in [`renovate`](https://github.com/jay-withers/renovate); [`renovate.json`](renovate.json) just extends them, so policy changes land centrally.
